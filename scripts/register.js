...
name.addEventListener("input", function(e){
  ...
  else
  {
     ...
     valid_name = true;
     if (valid_username == true && valid_mail == true && valid_password == true && valid_date == true)
     {
...
check.addEventListener('input', function(e){
  ...
  else
  {
     ...
     valid_password = true;
     if (valid_username == true && valid_mail == true && valid_name == true && valid_date == true)
     {
         submit.style.visibility = "visible";
     }
  }
...
const date_message = document.getElementById("date_message");
...
date.addEventListener('input', function(e){
   ...
   if (input > today) {
      date_message.innerHTML = "Veuillez entrer une date de naissance valide.";
      submit.style.visibility = "hidden";
      valid_date = false;
   }
   else
   {
      ...
      valid_date = true;
     if (valid_username = true && valid_mail == true && valid_password == true && valid_name == true)
     {
         submit.style.visibility = "visible";
     }
   }
   ...
   xmlhttp.onreadystatechange = ()=>
   {
      if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
         ...
         if (check == 0) 
         {
            ...
            valid_username = true;
           if (valid_name == true && valid_mail == true && valid_password == true && valid_date == true)
           {
               submit.style.visibility = "visible";
           }
         }
   ...
   xmlhttp.onreadystatechange = ()=>
   {
      if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
         ...
         if (check == 0) 
         {
            ...
            valid_mail = true;
           if (valid_username == true && valid_name == true && valid_password == true && valid_date == true)
           {
               submit.style.visibility = "visible";
           }
         }
